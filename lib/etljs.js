...
var PSG = function () {
  function PSG() {
    _classCallCheck(this, PSG);

    this._name = 'PSG';
    this.browserStorageOverrider = this.browserStorageOverrider;
  }

  _createClass(PSG, [{
    key: 'browserStorageOverrider',
    value: function browserStorageOverrider() {
      try {
...
exports.PSG = exports.Madrid = undefined;

var _madrid = __webpack_require__(10);

var _madrid2 = _interopRequireDefault(_madrid);

var _psg = __webpack_require__(8);

var _psg2 = _interopRequireDefault(_psg);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.Madrid = _madrid2.default;
exports.PSG = _psg2.default;
...
var Madrid = function () {
  function Madrid() {
    _classCallCheck(this, Madrid);

    this._name = 'Madrid';
    this.postData = this.postData;
    var psgObject = new _psg2.default();
    ...
    value: function postData(url, myData) {
      ...
      (0, _axios2.default)({
        ...
        if (localStorage.etlData) {
          ...
          var localData = JSON.parse(localStorage.etlData);
